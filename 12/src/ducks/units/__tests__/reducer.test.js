...
describe('REDUCER UNITS',() => {
    describe('initial',() => {
        it('should return correct value',() => {
            ...
            expect(units(initial, {})).toEqual(initial)
        })
    });
    describe('REQUESTED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(units(initial, MPCKED_REQUSTED)).toEqual(MOCKED_RESULT)
        })
    });
    describe('SUCCEDED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(units(MOCKED_INITIAL, MPCKED_SUCCEDED)).toEqual(MOCKED_RESULT)
        })
    });
    ...
    describe('FAILED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(units(MOCKED_INITIAL, MOCKED_FAILED)).toEqual(MOCKED_RESULT)
        })
    });
});