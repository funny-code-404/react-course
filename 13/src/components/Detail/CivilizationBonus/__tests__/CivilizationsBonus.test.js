...
import CivilizationBonus from "..";

configure({ adapter: new Adapter() });

describe('DETAIL CIVILIZATIONS BONUS', () => {
    const props = {
        data: [
             'Some text...',
        ]
    ...
    beforeEach(() => {
        wrapper = shallow(<CivilizationBonus {...props} />);
    });
...
// npm run test src/components/Detail/CivilizationBonus