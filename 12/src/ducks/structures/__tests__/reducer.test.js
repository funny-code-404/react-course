import { structures } from "../reducer";

describe('REDUCER STRUCTURES',() => {
    describe('initial',() => {
        it('should return correct value',() => {
            ...
            expect(structures(initial, {})).toEqual(initial)
        })
    });
    describe('REQUESTED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(structures(initial, MPCKED_REQUSTED)).toEqual(MOCKED_RESULT)
        })
    });
    describe('SUCCEDED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(structures(MOCKED_INITIAL, MPCKED_SUCCEDED)).toEqual(MOCKED_RESULT)
        })
    });
    ...
    describe('FAILED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(structures(MOCKED_INITIAL, MOCKED_FAILED)).toEqual(MOCKED_RESULT)
        })
    });
});