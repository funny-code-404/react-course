import { technologies } from "../reducer";

describe('REDUCER TECHNOLOGIES',() => {
    describe('initial',() => {
        it('should return correct value',() => {
            ...
            expect(technologies(initial, {})).toEqual(initial)
        })
    });
    describe('REQUESTED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(technologies(initial, MPCKED_REQUSTED)).toEqual(MOCKED_RESULT)
        })
    });
    describe('SUCCEDED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(technologies(MOCKED_INITIAL, MPCKED_SUCCEDED)).toEqual(MOCKED_RESULT)
        })
    });
    ...
    describe('FAILED ACTIONS',() => {
        it('should return correct value',() => {
            ...
            expect(technologies(MOCKED_INITIAL, MOCKED_FAILED)).toEqual(MOCKED_RESULT)
        })
    });
});